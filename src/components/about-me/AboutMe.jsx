  ...
  return (
    ...
    >
      <header className="text- m-10 mt-20">
        <h1 className="uppercase  font-humane-black py-8 tracking-wide work-letters w-full text-[#444] text-[11vw] sm:text-[5rem] xl:text-[6rem] 2xl:text-[7.5rem]  border-y border-black border-opacity-20 px-4 sm:px-0 inline-block">
        ...
        <div className="flex flex-wrap justify-between mt-4 text-[#858585] text-sm sm:text-base lg:text-lg font-days-one gap-2">
