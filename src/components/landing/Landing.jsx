  ...
  return (
    <div className='landing bg-black-bg h-[100svh] w-full overflow-hidden relative'>
      <div className="landing-text relative flex flex-col justify-center text-center items-center h-full z-[1]">
        <h4 className='font-sansation-light text-white sm:text-[1.25rem]'>Hi there, I am</h4>
        <h2 className="font-allison text-[#bfbfbf] mt-[-0.5rem] sm:mt-0 text-[3.5rem] sm:text-[6rem] lg:text-[7.25rem]">Fahad Noufal</h2>
        <img src={creative} alt="Creative" className='px-2 sm:w-[70%] lg:w-[50%]' />
        <h3 className='font-days-one text-[#bfbfbf] mt-[1.5rem] sm:mt-[2rem] lg:mt-[3.5rem] sm:text-[1.2rem] lg:text-[1.8rem]'>FRONTEND DEVELOPER</h3>
        <div className="flower absolute z-[-1] animate-fadeInSlow">
          <img src={flower} alt="Flower" className='mt-[16rem] sm:w-auto w-[60%] mx-auto mb-28 sm:mb-0 sm:h-[80svh]' />
        </div>
